...
export function LessonRecordFooter({ step, pending, onPrevious, onNext, onComplete }: Props) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-[#dfe3da] bg-[#fbfaf6]/96 px-4 py-3 shadow-[0_-5px_18px_rgba(60,70,58,0.08)] backdrop-blur md:left-[var(--app-sidebar-width)]">
