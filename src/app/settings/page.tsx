            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <form action="/auth/sign-out" method="post">
                  <button
                    type="submit"
                    className="inline-flex h-10 items-center gap-2 rounded-lg border border-[#e0d4c7] bg-white px-4 text-[13px] font-bold text-[#6b7468]"
                  >
      ...
      <MobileSettingCard title="基本アカウント設定" icon={UserRound}>
        <div className="space-y-3">
          ...
          <form action="/auth/sign-out" method="post">
            <button
              type="submit"
              className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-xl border border-[#e0d4c7] bg-white text-[13px] font-bold text-[#6b7468]"
            >
              <LogOut className="h-4 w-4" />
              ログアウト
            </button>
